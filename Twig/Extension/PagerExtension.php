...
namespace Zikula\PagesModule\Twig\Extension;
...
class PagerExtension extends \Twig_Extension
{
    ...
    {
        return array(
            new \Twig_SimpleFunction('pages_pager', [$this, 'pager'], array('is_safe' => array('html'))),
        );
    }

    /**
     * @TODO Only for use until Core-1.4.2 is released!!!
     */
    public function pager($params)
    {
        ...
        $templateName = (isset($params['template'])) ? $params['template'] : 'ZikulaPagesModule:Pager:pagercss.html.twig';
    ...
    {
        return 'zikulapagesmodule_pager';
    }
}
