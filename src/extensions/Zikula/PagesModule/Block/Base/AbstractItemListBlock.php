...
abstract class AbstractItemListBlock extends AbstractBlockHandler
{
    ...
    {
        return $this->trans('Pages list');
    }
    
    public function display(array $properties = []): string
    {
        // only show block content if the user has the required permissions
        if (!$this->hasPermission('ZikulaPagesModule:ItemListBlock:', $properties['title'] . '::', ACCESS_OVERVIEW)) {
            return '';
        }
        ...
        if (empty($properties['title'])) {
            $properties['title'] = $this->trans('Pages list');
        }
    ...
    protected function getDisplayTemplate(array $properties = []): string
    {
        ...
        foreach ($templateOptions as $templatePath) {
            if ($this->twigLoader->exists('@ZikulaPagesModule/' . $templatePath)) {
                $template = '@ZikulaPagesModule/' . $templatePath;
                break;
            }
        }
    ...
    {
        return '@ZikulaPagesModule/Block/itemlist_modify.html.twig';
    }
