...
abstract class AbstractKernelListener implements EventSubscriberInterface
{
     ...
     *     `$testMessage = 'Hello from pages app';
     *     $event->getRequest()->attributes->set('ZikulaPagesModule_test', $testMessage);`
     *
     ...
     *     `$testMessage = $event->getRequest()->attributes->get('ZikulaPagesModule_test');`
     *     now `$testMessage` should be: `'Hello from pages app'`
     *
     ...
     *         $response = new Response();
     *         $message = sprintf(
     *             'pages App Error says: %s with code: %s',
