...
namespace Zikula\PagesModule\Needle\Base;
...
abstract class AbstractPageNeedle implements NeedleInterface
{
    ...
    {
        return 'PAGES{PAGES|PAGE-pageId}';
    }
    ...
    public function apply(string $needleId, string $needleText): string
    {
        ...
        $needleText = str_replace('PAGES', '', $needleText);
        ...
        $route = $this->router->generate(
            'zikulapagesmodule_page_display',
