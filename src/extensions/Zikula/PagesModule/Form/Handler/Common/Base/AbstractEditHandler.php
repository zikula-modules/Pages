...
namespace Zikula\PagesModule\Form\Handler\Common\Base;
...
abstract class AbstractEditHandler
{
    ...
    public function processForm(array $templateParameters = [])
    {
        ...
        if (null !== $session) {
            // default to referer
            $refererSessionVar = 'zikulapagesmodule' . $this->objectTypeCapital . 'Referer';
        ...
        if ('edit' === $this->templateParameters['mode']) {
            ...
            if (null !== $entity) {
                if (
                    ...
                    $lockName = 'ZikulaPagesModule' . $this->objectTypeCapital . $entity->getKey();
                ...
                if (null !== $session && in_array($this->objectType, ['page'], true)) {
                    ...
                    $routePrefix = 'zikulapagesmodule_' . $this->objectTypeLower . '_';
        ...
        if ($this->form->isSubmitted()) {
            if ($this->form->has('cancel') && $this->form->get('cancel')->isClicked()) {
                if (
                    ...
                    $lockName = 'ZikulaPagesModule' . $this->objectTypeCapital . $this->entityRef->getKey();
