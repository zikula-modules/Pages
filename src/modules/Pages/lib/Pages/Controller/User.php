...
class Pages_Controller_User extends Zikula_Controller
{
    ...
    public function main()
    {
        ...
        return $this->view->fetch('pages_user_main.htm');
    }
    ...
    public function view($args)
    {
            ...
            foreach ($items as $item) {
                if (SecurityUtil::checkPermission('Pages::', "$item[title]::$item[pageid]", ACCESS_OVERVIEW)) {
                    ...
                    if (SecurityUtil::checkPermission('Pages::', "$item[title]::$item[pageid]", ACCESS_READ)) {
                        $pages[] = $this->view->fetch('pages_user_rowread.htm', $item['pageid']);
                    } else {
                        $pages[] = $this->view->fetch('pages_user_rowoverview.htm', $item['pageid']);
                    }
                }
            }
            unset($items);
        ...
        // Return the output that has been generated by this function
        return $this->view->fetch('pages_user_view.htm');
    }
    ...
    public function display($args)
    {
        ...
        if (isset($pageid) && $this->view->template_exists('pages_user_display_' . $pageid . '.htm')) {
